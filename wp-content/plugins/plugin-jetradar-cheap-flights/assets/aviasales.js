...
jQuery(document).ready(function() {
	...
	jQuery(".aviasales_select span").text("full kitchen (+ $100)");
	jQuery("#origin_name").val("PICK-UP");
	jQuery("#destination_name").val("DROP-OFF");
	
	jQuery('#trip_class option[value="0"]').text("jacuzzi (+ $180)");
	jQuery('#trip_class option[value="1"]').text("flight attendant (+ $300)");
